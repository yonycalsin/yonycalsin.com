...
/**
 * @todo rename to the right approach
 * @author yonycalsin
 */
const getPostsDataResponseOk: PostResponsePayload[] = [
  {
 ...
 * @author yonycalsin
 */
const getPostsResponseOk: ServerListResponse<PostResponsePayload> = {
  error: null,
...
export { getPostsDataResponseOk, getPostsResponseOk }
