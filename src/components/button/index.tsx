...
const styles = {
  ...
  light: {
    primary:
      'px-2 py-1 rounded-md font-medium border-0 focus:outline-none focus:ring transition text-primary bg-primary-100 hover:bg-primary-200 active:bg-primary-300 focus:ring-primary-300',
    secondary:
      'px-2 py-1 rounded-md font-medium border-0 focus:outline-none focus:ring transition text-secondary bg-secondary-100 hover:bg-secondary-200 active:bg-secondary-300 focus:ring-secondary-300',
    gray: 'px-2 py-1 rounded-md font-medium border-0 focus:outline-none focus:ring transition text-gray bg-gray-100 hover:bg-gray-200 active:bg-gray-300 focus:ring-gray-300',
  },
}
