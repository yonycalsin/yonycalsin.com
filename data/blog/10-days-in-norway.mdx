...
<Image alt={`Norway`} src={`/static/images/10-days-in-norway/banner.png`} width={1501 / 2} height={712 / 2} priority />
...
<Image alt={`Moskenes Ferry`} src={`/static/images/10-days-in-norway/ferry.jpg`} width={5421 / 6} height={3614 / 6} />
...
<Image alt={`Row Boat`} src={`/static/images/10-days-in-norway/row.jpg`} width={5472 / 4} height={3648 / 4} />
...
<Image alt={`DJI Mavic`} src={`/static/images/10-days-in-norway/clouds.jpg`} width={2394 / 3} height={2394 / 3} />
...
<Image alt={`Midnight Sun`} src={`/static/images/10-days-in-norway/fog.jpg`} width={2918 / 3} height={2216 / 3} />
